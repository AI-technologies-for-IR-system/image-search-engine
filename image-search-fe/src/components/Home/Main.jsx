      ...
      <div className="App-content" ref={contentRef}>
        <div className="App-content-article">
          ...
          <span className="App-article">
            ...
            для вирішення задачі класифікації на прикладі 
        ...
        <div className="App-content-article">
          <div className="App-article-container">
            ...
            нашою командою розробників була натренована нейронна мережа, що дозволяє 
            дізнатися користувачам породу собаки із фотографії, а також отримати так 
            звану "впевненість" мережі у своєму виборі - належність до того чи іншого 

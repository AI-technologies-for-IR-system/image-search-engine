...
import { actions, selectors } from '../../store/results'
...
const Results = () => {
  ...
  const rows = useSelector(selectors.getResults) ?? []

  useEffect(() => dispatch(actions.getResults()), [])
  ...
  return (
    <div>
      <h1 style={{ fontSize: 40, textAlign: "center" }}>Збережені запити</h1>
      <div>
